...
import { handleCommentWrite, handleDislikeWrite, handleLikeWrite } from "@/libs/writePost";
    ...
    <div className="bg-white rounded-2xl p-5 pb-2">
      ...
      <div className="flex gap-4 text-sky-600 items-center">
        ...
        <div className=" transition-all flex gap-0 items-center" onClick={() => setShowComments((prev) => !prev)}>
          ...
          {post.commentsLength > 0 ? <span className="text-sm">{post.commentsLength}</span> : null}
        </div>
